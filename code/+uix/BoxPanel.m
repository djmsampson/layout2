        ...
        function redrawBorders( obj )
            ...
            switch obj.BorderType_
                ...
                case 'etchedin'
                    ...
                    leftMask(1:(leftPosition(3)-1)/2,:) = false;
                    leftMask(end-(leftPosition(3)-1)/2:end-1,1:(leftPosition(3)-1)/2) = ...
                        fliplr( tril( ones( (leftPosition(3)-1)/2 ) ) == 1 );
                    leftMask(end-leftPosition(3)+1:end-(leftPosition(3)+1)/2,(leftPosition(3)-1)/2+1:end) = ...
                        fliplr( tril( ones( (leftPosition(3)-1)/2 ) ) == 0 );
                    rightMask = [false( [rightPosition(4)+1, (rightPosition(3)-1)/2] ), ...
                        true( [rightPosition(4)+1, (rightPosition(3)-1)/2] )];
                    rightMask(end-(rightPosition(3)-1)/2:end-1,:) = true;
                    rightMask(end-(rightPosition(3)-1)/2:end-1,1:(rightPosition(3)-1)/2) = ...
                        fliplr( tril( ones( (rightPosition(3)-1)/2 ) ) == 0 );
                    rightMask(1:(rightPosition(3)-1)/2,(rightPosition(3)+1)/2:end) = ...
                ...
                case 'etchedout'
                    ...
                    leftMask(1:(leftPosition(3)-1)/2,:) = true;
                    leftMask(end-(leftPosition(3)-1)/2:end-1,1:(leftPosition(3)-1)/2) = ...
                        fliplr( tril( ones( (leftPosition(3)-1)/2 ) ) == 0 );
                    leftMask(end-leftPosition(3)+1:end-(leftPosition(3)+1)/2,(leftPosition(3)-1)/2+1:end) = ...
                        fliplr( tril( ones( (leftPosition(3)-1)/2 ) ) == 1 );
