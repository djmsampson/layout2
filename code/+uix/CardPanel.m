classdef CardPanel < uix.Container
    ...
    methods
        ...
        function set.Selection( obj, value )
            ...
            assert( isreal( value ) && ~isinf( value ) && ...
                ~isnan( value ) && rem( value, 1 ) == 0 && value >= 0, ...
                'uix:InvalidPropertyValue', ...
                'Property ''Selection'' must be a positive integer.' )
            %             assert( value <= numel( obj.Contents_ ), ...
            %                 'uix:InvalidPropertyValue', ...
            %                 'Property ''Selection'' must be less than or equal to the number of contents.' )
