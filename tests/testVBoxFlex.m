function test_suite = testVBoxFlex()
%testVBoxFlex  Unit tests for uiextras.VBoxFlex
%
...
close all force;
assertEqual( isa( uiextras.VBoxFlex(), 'uiextras.VBoxFlex' ), true );
close all force;
...
assertEqual( isa( uiextras.VBoxFlex( args{:} ), 'uiextras.VBoxFlex' ), true );
close all force;
...
h = uiextras.VBoxFlex();
assertEqual( isa( h, 'uiextras.VBoxFlex' ), true );
