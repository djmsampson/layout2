classdef tPanels < ContainerSharedTests
    ...
    properties (TestParameter)
        ...
        GetSetPVArgs = {
            ...
            {'uiextras.CardPanel', 'BackgroundColor', [1 1 0]}
            {'uiextras.TabPanel', 'BackgroundColor', [1 1 0], ...
             'TabNames', {'Tab 1', 'Tab 2', 'Tab 3'}, ...
             'TabEnable', {'on', 'off', 'on'}, 'TabPosition', 'bottom', 'TabSize', 10, ...
             'ForegroundColor', [1 1 1], 'HighlightColor', [1 0 1], 'ShadowColor', [0 0 0]};
            {'uiextras.BoxPanel', 'BackgroundColor', [1 1 0], 'IsMinimized', false, ...
             'IsDocked', true, 'BorderType', 'etchedout', 'BorderWidth', 10, ...
             'Title', 'box panel test', 'TitleColor', [1 0 0], ...
             'ForegroundColor', [1 1 1], 'HighlightColor', [1 0 1], 'ShadowColor', [0 0 0]}
            };
        SpecialConstructionArgs = {
            {'uiextras.Panel', 'FontAngle', 'normal', 'FontName', 'Arial', ...
             'FontSize', 20, 'FontUnits', 'points', 'FontWeight', 'bold'}
            {'uiextras.CardPanel'}
            {'uiextras.TabPanel', 'FontAngle', 'normal', 'FontName', 'Arial', ...
             'FontSize', 20, 'FontUnits', 'points', 'FontWeight', 'bold'}
            {'uiextras.BoxPanel', 'BorderType', 'etchedout', 'FontAngle', 'normal', ...
             'FontName', 'Arial', 'FontSize', 20, 'FontUnits', 'points', 'FontWeight', 'bold'}
            };
    end
