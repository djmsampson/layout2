    ...
    methods
        ...
        function set.FontAngle( obj, ~ )
            ...
            warning( 'uix:Deprecated', ...
                'Property ''FontAngle'' of %s will be removed in a future release.', ...
                class( obj ) )
        ...
        function set.FontName( obj, ~ )
            ...
            warning( 'uix:Deprecated', ...
                'Property ''FontName'' of %s will be removed in a future release.', ...
                class( obj ) )
        ...
        function set.FontSize( obj, ~ )
            ...
            warning( 'uix:Deprecated', ...
                'Property ''FontSize'' of %s will be removed in a future release.', ...
                class( obj ) )
        ...
        function set.FontWeight( obj, ~ )
            ...
            warning( 'uix:Deprecated', ...
                'Property ''FontWeight'' of %s will be removed in a future release.', ...
                class( obj ) )
        ...
        function set.FontUnits( obj, ~ )
            ...
            warning( 'uix:Deprecated', ...
                'Property ''FontUnits'' of %s will be removed in a future release.', ...
                class( obj ) )
        ...
        function set.HighlightColor( obj, ~ )
            ...
            warning( 'uix:Deprecated', ...
                'Property ''ForegroundColor'' of %s will be removed in a future release.', ...
                class( obj ) )
        ...
        function set.ShadowColor( obj, ~ )
            ...
            warning( 'uix:Deprecated', ...
                'Property ''ShadowColor'' of %s will be removed in a future release.', ...
                class( obj ) )
        ...
        function set.TabWidth( obj, ~ )
            ...
            warning( 'uix:Deprecated', ...
                'Property ''TabWidth'' of %s will be removed in a future release.', ...
                class( obj ) )
