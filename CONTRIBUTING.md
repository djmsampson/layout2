...
- `/tests`: the toolbox tests, written in the MATLAB&reg; unit test framework
- `/releases`: the archive of previous MATLAB toolbox (.mltbx) releases

## Guidelines

We support a **wide** range of MATLAB versions:

* With `figure`, from MATLAB R2014b
* With `uifigure`, from MATLAB R2022a

This precludes the use of some modern features.
